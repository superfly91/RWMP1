...
function Game(canvas, context, ASSET_MANAGER)
{
    ...
    // SETUP WORLD
	this.world = new this.b2World(new this.b2Vec2(0, 10),  false );

    // BOTTOM (GROUND)
    this.ground = new PhysicsObject(canvas,context,this.world,"static",20,2,10,(400/30)+1.8,DENSITY,FRICTION,REST);
    // TOP
    ...
    // RIGHT
    this.rightBorder = new PhysicsObject(canvas,context,this.world,"static",2,14,(800/30)+1.8,3,DENSITY,FRICTION,REST);
    // A PHYSICS BOX
    ...
    this.player = new PhysicsObject(canvas,context,this.world,"dynamic",0.1,0.2,5,5,DENSITY,FRICTION,REST);
